...
### 2026-09-09 · print pipeline P3 + P4 (16/25) ✅ **quotation · invoice/ใบกำกับ · ใบสั่งซื้อ พิมพ์ได้จริง**
...
3. **`POST /purchase-orders/:id/print`** (supplier-bc) — endpoint ใหม่ตัวแรกหลัง P2 + เทมเพลต
